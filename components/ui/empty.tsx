...
function Empty({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="empty"
      className={cn(
        'flex min-w-0 flex-1 flex-col items-center justify-center gap-5 rounded-lg border border-dashed bg-surface-soft/60 p-6 text-center text-balance md:p-10',
        className,
      )}
      {...props}
    />
